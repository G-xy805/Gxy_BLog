...
public:
    ...
    SmartPointer(T* p=0): _ptr(p), _reference_count(new size_t){
        std::cout << "智能指针构造函数被调用 SmartPointer constructor called" << std::endl;
        if(p)
            *_reference_count = 1;
        else
            *_reference_count = 0;
    ...
    SmartPointer(const SmartPointer& src) {
        std::cout << "智能指针拷贝构造函数被调用 SmartPointer copy constructor called" << std::endl;
        if(this!=&src) {
            _ptr = src._ptr;
    ...
    SmartPointer& operator=(const SmartPointer& src) {
        std::cout << "智能指针赋值操作符被调用 SmartPointer assignment operator called" << std::endl;
        if(_ptr==src._ptr) {
            return *this;
        }
        releaseCount();
    ...
    //重载操作符
    T& operator*() {
        std::cout << "智能指针operator*被调用 SmartPointer operator* called" << std::endl;
        if(_ptr) {
            return *_ptr;
        }
        //throw exception
    ...
    //析构函数
    ~SmartPointer() {
        std::cout << "智能指针析构函数被调用 SmartPointer destructor called" << std::endl;
...
private:
    ...
    void releaseCount() {
        std::cout << "智能指针releaseCount函数被调用 SmartPointer releaseCount called" << std::endl;
        if(_ptr) {
            (*_reference_count)--;
            if((*_reference_count)==0) {
                delete _ptr;
...
智能指针构造函数被调用 SmartPointer constructor called
智能指针拷贝构造函数被调用 SmartPointer copy constructor called
智能指针构造函数被调用 SmartPointer constructor called
智能指针赋值操作符被调用 SmartPointer assignment operator called
智能指针releaseCount函数被调用 SmartPointer releaseCount called
智能指针赋值操作符被调用 SmartPointer assignment operator called
智能指针赋值操作符被调用 SmartPointer assignment operator called
智能指针构造函数被调用 SmartPointer constructor called
智能指针赋值操作符被调用 SmartPointer assignment operator called
...
智能指针析构函数被调用 SmartPointer destructor called
智能指针析构函数被调用 SmartPointer destructor called
智能指针析构函数被调用 SmartPointer destructor called
智能指针析构函数被调用 SmartPointer destructor called
```
