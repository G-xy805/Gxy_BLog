...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200612180442942.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2lmd2VjYW5kZQ==,size_16,color_FFFFFF,t_70)## 4.单继承和多继承的虚函数表
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200612181540388.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2lmd2VjYW5kZQ==,size_16,color_FFFFFF,t_70)## 5.结构总结
**对于一个普通的A类**
